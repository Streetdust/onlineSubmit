                                    ...
                                    <div class='step-content'>
                                        ...
                                        <div class='step-pane active' id='step1'>
                                            <div class='control-group'>
                                                <label class='control-label' for='inputText'>选择您要下载作业的班级</label>
                                                <div class='controls'>
                                                    <!--第一步内容start-->
                                                    <div class='row-fluid'>
                                                            ...
                                                            <div class='box-content'>
                                                                <div class='row-fluid'>
                                                                    <div class='span12'>
                                                                        <div class='row-fluid'>
                                                                            <strong>班级列表</strong>
                                                                            <select id="inputText" class='select2 input-block-level'>
                                                                                <optgroup
                                        ...
                                        <div class='step-pane' id='step2'>
                                            <div class='control-group'>
                                                <label class='control-label' for='inputPassword'>选择您要下载作业的科目</label>
                                                <div class='controls'>
                                                    <!--第二部分内容 start-->
                                                    <div class='row-fluid'>
                                                        <div class='span4 box bordered-box blue-border'>
                                                            ...
                                                            <div class='box-content'>
                                                                <div class='row-fluid'>
                                                                    <div class='span12'>
                                                                        <div class='row-fluid'>
                                                                            <strong>科目列表</strong>
                                                                            <select id="inputPassword" class='select2 input-block-level'>
                                                                                <optgroup
                                                                                        label='Alaskan/Hawaiian Time Zone'>
                                                                                    <option value='AK'/>
                                                                                    Alaska
                                        ...
                                        <div class='step-pane' id='step3'>
                                            <div class='control-group'>
                                                <label class='control-label' for='inputTextArea'>选择您要下载的作业</label>
                                                <div class='controls'>
                                                    <!--第三部分内容 start-->
                                                    <hr class='hr-double'/>
                                                    <div class='container'>
                                                        <table id="inputTextArea" class="table table-condensed table-striped table-hover">
                                                            <th>
                                                                <%--<td>序号</td>--%>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><i class="icon-remove"></i><i class="icon-ok"></i></td>
                                                            </tr>
                                                            <tr>
                                                                <td><input type="checkbox" /></td>
                                                                <td>1</td>
                                        ...
                                        <div class='step-pane' id='step4'>
                                            <div class='control-group'>
                                                <label class='control-label' for='chooseFile'>请勾选您要下载的文件:</label>
                                                <table>
                                                    <th>
                                                    <td style="width: 80px;">
                                                ...
                                                <div id="chooseFile" class='controls'>
                                                ...
                                                <hr class='hr-normal'/>
                                                <button class="btn btn-success" name="button" style="margin-bottom:5px" type="submit">
                                                    点击下载
                                                </button>
                                                <button class="btn btn-danger" name="button" style="margin-bottom:5px" type="submit">
                                                    取消下载
                                                </button>
