...
<body class='contrast-red '>
		...
		<nav class='' id='main-nav'>
			<div class='navigation'>
				...
				<ul class='nav nav-stacked'>
					...
					<li class='active'><a href='manageTeacherInfo.jsp'> <i
							class='icon-cog'></i> <span>管理教师信息</span>
					</a></li>
					
					<li class=''><a href='FileUpload.jsp'> <i
						...
						<div class='row-fluid'>
							<div class='span12'>
								<div class='page-header'>
									<h1 class='pull-left'>
										<i class='icon-list-ul'></i> <span>管理教师信息</span>
									</h1>
												...
												<div class='responsive-table'>
													<div class='scrollable-area' style="height: 500px">
														...
														<table id="dateGrid" class="easyui-datagrid"
															...
															data-options="pagination:true,rownumbers:true,singleSelect:true,url:'adminctlr/searchAllTeacher.do',method:'get',toolbar:'#tb'">
															<thead>
																<tr>
																	<th data-options="field:'teacherId',align:'center'">学号</th>
																	<th data-options="field:'teacherName',align:'center'">姓名</th>
																	<th data-options="field:'teacherPass' ,align:'center'">密码</th>
																	<th data-options="field:'teacherTel' ,align:'center'">班级编号</th>
									...
									<div class='modal hide fade' id='deleteChooseObject'
										...
										<div class='modal-footer'>
											<button id="deleteOneTeaInfo" class='btn btn-danger'
									...
									<div class='modal hide fade' id='addNewTeaInfo' role='dialog'
										tabindex='-1'>
										<div class='modal-header'>
											<button class='close' data-dismiss='modal' type='button'>&times;</button>
											<h3>新增教师信息</h3>
										...
										<div class='modal-body'>
											...
											<div class='control-group'>
												...
												<div class='controls'>
													<input class='span12' id='teaId' type="number" />
													<p class='help-block' />
												</div>
											</div>
											...
											<div class='control-group'>
												...
												<div class='controls'>
													<input class='span12' id='teaName' type='text' />
													<p class='help-block' />
												</div>
											</div>
											...
											<div class='control-group'>
												...
												<div class='controls'>
													<input class='span12' id='teaPass' type="password" />
													<p class='help-block' />
												</div>
											</div>
											...
											<div class='control-group'>
												...
												<div class='controls'>
													<input class='span12' id='teaTel' type="number" />
													<p class='help-block' />
												</div>
											</div>
										...
										<div class='modal-footer'>
											...
											<button id="addNewTeaInfoBtn" class='btn btn-primary'  data-dismiss='modal'>确认添加</button>
										</div>
									</div>
								</div>
							</div>
							...
							<div class='modal hide fade' id='editNowTeaInfo' role='dialog'
								tabindex='-1'>
								<div class='modal-header'>
									<button class='close' data-dismiss='modal' type='button'>&times;</button>
									<h3>新增教师信息</h3>
								...
								<div class='modal-body'>
									...
									<div class='control-group'>
												<label class='control-label'>教师编号(暂不提供修改)</label>
												<div class='controls'>
													<input class='input-xlarge span12' id='editTeaId' disabled=''
												type="number" value="" />
													<p class='help-block' />
												</div>
											</div>
									...
									<div class='control-group'>
										<label class='control-label'>教师姓名</label>
										<div class='controls'>
											<input class='span12' id='editTeaName' type='text' />
											<p class='help-block' />
										</div>
									</div>
									...
									<div class='control-group'>
										<label class='control-label'>教师密码</label>
										<div class='controls'>
											<input class='span12' id='editTeaPass' type="password" />
											<p class='help-block' />
										</div>
									</div>
									...
									<div class='control-group'>
										<label class='control-label'>联系方式</label>
										<div class='controls'>
											<input class='span12' id='editTeaTel' type="number" />
											<p class='help-block' />
										</div>
									</div>
								...
								<div class='modal-footer'>
									<button class='btn btn-primary' data-dismiss='modal'>取消修改</button>
									<button id="editNowTeaInfoBtn" class='btn btn-danger' data-dismiss='modal'>确认修改</button>
								</div>
							</div>
						</div>
					</div>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
				...
				toolbar : [ {
					...
					handler : function() {
						...
						if (yourSelect == null) {
							...
							$("#editNowTeaInfo").modal()
							$("#editTeaId").attr("value", yourSelect.teacherId)
							$("#editTeaName").attr("value", yourSelect.teacherName)
							$("#editTeaPass").attr("value", yourSelect.teacherPass)
							$("#editTeaTel").attr("value", yourSelect.teacherTel)
					...
					handler : function() {
						...
						$.ajax({
						type : "post",
						url : "adminctlr/exportTeaInfoByExcel.do",
						dataType : "json",
						
						error : function(data) { //如果确定能正确运行,可不写
	
	
							return bootbox.dialog(data.exportTeaInfoByExcelResult, [
								{
									label : "确认",
									"class" : "btn-primary"
								}
			...
			$("#deleteOneTeaInfo").click(function() {
				var yourSelect = $("#dateGrid").datagrid("getSelected");
				var willdeleteUserid = yourSelect.teacherId;
	
				$.ajax({
					type : "post",
					url : "adminctlr/deleteOneTeaInfo.do",
					dataType : "text",
					data : {
						"teacherId" : willdeleteUserid
					},
					success : function(data) {
						$("#dateGrid").datagrid("reload")
						var json = eval("(" + data + ")")
	
						return bootbox.dialog(json.deleteTeaResulkt, [
							{
								label : "确认",
								"class" : "btn-primary"
							}
			...
			$("#addNewTeaInfoBtn").click(function() {
				var teaId = $("#teaId").val();
				...
				if (teaId.length != 0 && teaName.length != 0 && teaPass.length != 0 && teaTel.length != 0) {
					$.ajax({
						type : "post",
						url : "adminctlr/addOneTeaInfo.do",
						dataType : "json",
						data : {
							"teaId" : teaId,
							"teaName" : teaName,
						...
						error : function(data) { //如果确定能正确运行,可不写
							...
							return bootbox.dialog(data.addTeaResult, [
								{
									label : "确认",
									"class" : "btn-primary"
								}
			...
			$("#teaId").blur(function() {
				...
				$.ajax({
					...
					error : function(data) { //如果确定能正确运行,可不写
						...
						return bootbox.dialog(data.teaIdCheck, [
							{
								label : "确认",
								"class" : "btn-primary"
							}
			...
			$("#editNowTeaInfoBtn").click(function() {
				var yourSelect = $("#dateGrid").datagrid("getSelected");
				
				var teacherId = $("#dateGrid").datagrid("getSelected").teacherId;
				var teacherName = $("#dateGrid").datagrid("getSelected").teacherName;
				var teacherPass = $("#dateGrid").datagrid("getSelected").teacherPass;
				var teacherTel = $("#dateGrid").datagrid("getSelected").teacherTel;
				...
				var nowTeaName = $("#editTeaName").val();
				var nowTeaPass = $("#editTeaPass").val();
				var nowTeaTel = $("#editTeaTel").val();
	
	
				if (teacherName == nowTeaName && teacherPass == nowTeaPass && teacherTel == nowTeaTel) {
					...
					$.ajax({
						type : "post",
						url : "adminctlr/editTeaInfo.do",
						dataType : "json",
						data : {
							"teacherId" : teacherId,
							"teacherName" : nowTeaName,
							"teacherPass" : nowTeaPass,
							"teacherTel" : nowTeaTel
						},
						error : function(data) { //如果确定能正确运行,可不写
	
	
							return bootbox.dialog(data.editTeaResult, [
								{
									label : "确认",
									"class" : "btn-primary"
								}
